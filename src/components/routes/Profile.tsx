          ...
          <Box sx={{ display: "flex", justifyContent: "start" }}>
            <IconButton
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                />
                <path d="M12.5 7.5L15.5 5.5L18.5 8.5L16.5 11.5L12.5 7.5Z" fill="white" />
              </svg>
            </IconButton>
          </Box>
          <Box
      ...
      <Grid
        ...
        <svg width="100%" height="auto" viewBox="0 0 398 233" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <mask
            ...
            width="100%"
            height="233">
            <rect width="100%" height="232.483" rx="20" fill="#ED713C" />
          </mask>
          <g mask="url(#mask0_0_1)">
            <ellipse opacity="0.1" cx="30.9556" cy="269.124" rx="202.79" ry="142.775" fill="black" />
            <ellipse opacity="0.08" cx="367.044" cy="-36.6413" rx="202.79" ry="142.775" fill="black" />
          </g>
          <defs>
            <linearGradient
