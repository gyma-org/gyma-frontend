...
const FloatCard: React.FC<FloatCardProps> = ({ name, address, city, profile, onClick, maxWidth = 500, price, gymId, rate ,min_price}) => {
  ...
  return (
    <Box
              ...
              {min_price ? (
                <>
                  <Typography variant="h6" fontWeight="bold" color="black">
                    {/* <Typography component="span" variant="body2" fontWeight="medium" color="gray">
                      از
                    </Typography> */}
      ...
      <CardMedia
        onClick={onClick}
        image={profile ? `${API_BASE_URL}/medias/profile/${profile}` : "/images/fallback-image.png"}
        sx={{
          mr: 1,
          ml: 0.5,
          height: "100%",
