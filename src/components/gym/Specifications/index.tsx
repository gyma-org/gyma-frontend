  ...
  return (
    <Grid
      ...
      <Box display="flex" alignItems="center" justifyContent="space-between">
        <Box display="flex" gap={1} px={1} mt={1}>
      ...
      {/* Attributes */}
      <Box>
        <Box display="flex" alignItems="center" gap={1} mt={2} mr={1}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      {/* Time */}
      <Box>
        <Box display="flex" alignItems="center" gap={1} mt={1} mr={1}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="7" stroke="#33363F" strokeWidth="2" />
            <path
